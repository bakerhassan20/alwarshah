...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">AlwaRshah</li>
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'admin/home')) }}"><svg
            ...
            @can('التقارير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('تقرير الاوردرات')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices_report')) }}">تقارير الاوردرات</a>
                            </li>
                        @endcan
