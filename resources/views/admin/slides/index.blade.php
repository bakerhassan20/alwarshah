...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الاعدادات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ سليد</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'>
                            ...
                            @foreach($sliders as $x)
                                ...
                                <tr>
                                    ...
                                    <td>{{$x->name}}</td>
                                    <td>{{$x->description}}</td>
                                    <td><img src="{{$x->img}}" width="100px"height="100px"></td>
                                    @if($x->active == 1)
                                    <td>فعال</td>
                                    @else
                                        <td>غير فعال</td>
                                    ...
                                    <td>
                                            ...
                                            <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                               data-id="{{ $x->id }}" data-section_name="{{ $x->name }}" data-toggle="modal"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-body">
                        <form action="/admin/addSlide" method="post">
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">رابط الصوره </label>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="/admin/updateSlider" method="post" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <label for="recipient-name" class="col-form-label">لينك الصوره :</label>
        ...
        <div class="modal" id="modaldemo9">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="/admin/deleteSlide" method="post">
